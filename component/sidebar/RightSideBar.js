                        ...
                        <div className="fz-offcanvas-main-contacts">
                            ...
                            <ul className="fz-offcanvas-main-contacts-list">
                                <li>
                                    ...
                                    <span className="fz-offcanvas-main-contact-text">TRK MAXIMA, ALMATY, KAZAKHSTAN</span>
                                </li>
                                <li>
                                    <i className="fa-thin fa-phone-flip"></i>
                                    <span className="fz-offcanvas-main-contact-text">
                                        <a href="tel:(+1)909-407-2988">+7 (771) 255-442</a> <br />
                                        <a href="tel:(+1)470-142-2412">+7 (771) 255-442</a>
                                    </span>
                                </li>
