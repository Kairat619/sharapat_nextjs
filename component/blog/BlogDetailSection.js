...
const BlogDetailSection = ({product}) => {
  return (
                    ...
                    <div className="fz-single-blog fz-inner-page-blog fz-blog-details">
                        <div className="fz-single-blog__img fz-blog-details__img">
                            ...
                            <div className="fz-blog-details__heading">
                                <h3 className="fz-single-blog__title fz-blog-details__title">{product.title}</h3>

                                <div className="fz-single-blog__infos fz-blog-details__infos">
                                    <span className="fz-single-blog__category fz-blog-details__category"><Link href="#">{product.category}</Link></span>
                                    <span className="fz-single-blog__date fz-blog-details__date">{product.date}</span>
                                </div>
                            </div>
                        </div>
